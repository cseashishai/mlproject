...
class DataTransformationConfig:
    preprocessor_obj_file_path = os.path.join('artific',"model.pkl")
...
class DataTransformation:
    ...
    def get_datatransformer_object(self):
        ...
        try:
            ...
            logging.info('numerical coloumn encoding completed')
            logging.info('categrical coloumn encoding completed')
    ...
    def intiate_data_transformation(self,train_path,test_path):
        try:
            ...
            logging.info(f"Saved Proccesing object.")
